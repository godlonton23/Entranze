...
public class Entranze implements Serializable {
        ...
        public Boolean getAmFollower() {
                return amFollower;
        }

        public void setAmFollower(Boolean amFollower) {
                this.amFollower = amFollower;
        }

        @SerializedName("amFollower")
        @Expose
        private Boolean amFollower;
