...
public class FollProfileAdapter extends RecyclerView.Adapter<FollProfileAdapter.ViewHolder>  {

    private List<Entranze> mItems;
    private Activity activity;
    private List<Entranze> mFilteredList;

    public FollProfileAdapter(Activity activity) {
        super();
        this.activity = activity;
        mItems = new ArrayList<Entranze>();
        mFilteredList= new ArrayList<Entranze>();
    }
    public void addData(Entranze events) {
        mItems.add(events);
        mFilteredList.add(events);
        ...
        viewHolder.cView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // }else {
                ...
                intent.putExtra("EVENT_COST", events.getPriceInCents());
