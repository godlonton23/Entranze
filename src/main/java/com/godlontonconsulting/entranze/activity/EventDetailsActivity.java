...
//                showError();
        ...
        btnGateKeeperscan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EventDetailsActivity.this, GateKeeperActivity.class);
     ...
     org.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EventDetailsActivity.this, FollowersEventsActivity.class);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,int id) {
                                if (selectedPay) {
                                    ...
                                    new SweetAlertDialog(EventDetailsActivity.this, SweetAlertDialog.WARNING_TYPE)
                                            .setTitleText("Error")
    ...
    private void loadCreditCardPayment(){
       ...
       // browser.getSettings().setCacheMode(2);
        ...
        browser.addJavascriptInterface(new PayFastJavaScriptInterface(EventDetailsActivity.this), "PayFast");
        //
        pref = new PrefManager(EventDetailsActivity.this.getApplicationContext());
